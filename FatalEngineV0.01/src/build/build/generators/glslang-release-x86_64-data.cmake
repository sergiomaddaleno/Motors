...
########### VARIABLES #######################################################################
#############################################################################################
set(glslang_PACKAGE_FOLDER_RELEASE "C:/.conan/aa8e81/1")
set(glslang_BUILD_MODULES_PATHS_RELEASE )


set(glslang_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_LIBS_RELEASE SPIRV glslang MachineIndependent glslang-default-resource-limits SPVRemapper HLSL OGLCompiler OSDependent GenericCodeGen)
set(glslang_SYSTEM_LIBS_RELEASE )
...
set(glslang_COMPONENTS_RELEASE glslang::GenericCodeGen glslang::OSDependent glslang::OGLCompiler glslang::HLSL glslang::SPVRemapper glslang::glslang-default-resource-limits glslang::MachineIndependent glslang::glslang glslang::SPIRV)
########### COMPONENT glslang::SPIRV VARIABLES ############################################

set(glslang_glslang_SPIRV_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_glslang_glslang_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include"
			"${glslang_PACKAGE_FOLDER_RELEASE}/include/glslang")
...
set(glslang_glslang_glslang_DEFINITIONS_RELEASE "-DENABLE_HLSL")
set(glslang_glslang_glslang_OBJECTS_RELEASE )
set(glslang_glslang_glslang_COMPILE_DEFINITIONS_RELEASE "ENABLE_HLSL")
...
set(glslang_glslang_glslang_SYSTEM_LIBS_RELEASE )
set(glslang_glslang_glslang_FRAMEWORK_DIRS_RELEASE )
set(glslang_glslang_glslang_FRAMEWORKS_RELEASE )
set(glslang_glslang_glslang_DEPENDENCIES_RELEASE glslang::MachineIndependent glslang::GenericCodeGen glslang::OSDependent glslang::OGLCompiler glslang::HLSL)
...
set(glslang_glslang_MachineIndependent_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_glslang_MachineIndependent_DEPENDENCIES_RELEASE glslang::GenericCodeGen glslang::OSDependent glslang::OGLCompiler)
...
set(glslang_glslang_glslang-default-resource-limits_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_glslang_SPVRemapper_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_glslang_HLSL_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
set(glslang_glslang_HLSL_LIB_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/lib")
set(glslang_glslang_HLSL_RES_DIRS_RELEASE )
set(glslang_glslang_HLSL_DEFINITIONS_RELEASE )
set(glslang_glslang_HLSL_OBJECTS_RELEASE )
set(glslang_glslang_HLSL_COMPILE_DEFINITIONS_RELEASE )
set(glslang_glslang_HLSL_COMPILE_OPTIONS_C_RELEASE "")
set(glslang_glslang_HLSL_COMPILE_OPTIONS_CXX_RELEASE "")
set(glslang_glslang_HLSL_LIBS_RELEASE HLSL)
set(glslang_glslang_HLSL_SYSTEM_LIBS_RELEASE )
set(glslang_glslang_HLSL_FRAMEWORK_DIRS_RELEASE )
set(glslang_glslang_HLSL_FRAMEWORKS_RELEASE )
set(glslang_glslang_HLSL_DEPENDENCIES_RELEASE )
set(glslang_glslang_HLSL_SHARED_LINK_FLAGS_RELEASE )
set(glslang_glslang_HLSL_EXE_LINK_FLAGS_RELEASE )
# COMPOUND VARIABLES
set(glslang_glslang_HLSL_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${glslang_glslang_HLSL_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${glslang_glslang_HLSL_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${glslang_glslang_HLSL_EXE_LINK_FLAGS_RELEASE}>
)
set(glslang_glslang_HLSL_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${glslang_glslang_HLSL_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${glslang_glslang_HLSL_COMPILE_OPTIONS_C_RELEASE}>")
########### COMPONENT glslang::OGLCompiler VARIABLES ############################################

set(glslang_glslang_OGLCompiler_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
set(glslang_glslang_OGLCompiler_LIB_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/lib")
set(glslang_glslang_OGLCompiler_RES_DIRS_RELEASE )
set(glslang_glslang_OGLCompiler_DEFINITIONS_RELEASE )
set(glslang_glslang_OGLCompiler_OBJECTS_RELEASE )
set(glslang_glslang_OGLCompiler_COMPILE_DEFINITIONS_RELEASE )
set(glslang_glslang_OGLCompiler_COMPILE_OPTIONS_C_RELEASE "")
set(glslang_glslang_OGLCompiler_COMPILE_OPTIONS_CXX_RELEASE "")
set(glslang_glslang_OGLCompiler_LIBS_RELEASE OGLCompiler)
set(glslang_glslang_OGLCompiler_SYSTEM_LIBS_RELEASE )
set(glslang_glslang_OGLCompiler_FRAMEWORK_DIRS_RELEASE )
set(glslang_glslang_OGLCompiler_FRAMEWORKS_RELEASE )
set(glslang_glslang_OGLCompiler_DEPENDENCIES_RELEASE )
set(glslang_glslang_OGLCompiler_SHARED_LINK_FLAGS_RELEASE )
set(glslang_glslang_OGLCompiler_EXE_LINK_FLAGS_RELEASE )
# COMPOUND VARIABLES
set(glslang_glslang_OGLCompiler_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${glslang_glslang_OGLCompiler_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${glslang_glslang_OGLCompiler_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${glslang_glslang_OGLCompiler_EXE_LINK_FLAGS_RELEASE}>
)
set(glslang_glslang_OGLCompiler_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${glslang_glslang_OGLCompiler_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${glslang_glslang_OGLCompiler_COMPILE_OPTIONS_C_RELEASE}>")
########### COMPONENT glslang::OSDependent VARIABLES ############################################

set(glslang_glslang_OSDependent_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
...
set(glslang_glslang_OSDependent_SYSTEM_LIBS_RELEASE )
...
set(glslang_glslang_GenericCodeGen_INCLUDE_DIRS_RELEASE "${glslang_PACKAGE_FOLDER_RELEASE}/include")
