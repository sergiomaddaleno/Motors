...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET minizip::minizip
                 ...
                 $<$<CONFIG:Release>:${minizip_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET minizip::minizip
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${minizip_INCLUDE_DIRS_RELEASE}> APPEND)
    set_property(TARGET minizip::minizip
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${minizip_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET minizip::minizip
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${minizip_COMPILE_OPTIONS_RELEASE}> APPEND)
