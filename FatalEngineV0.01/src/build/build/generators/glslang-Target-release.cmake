...
set_property(TARGET glslang_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:glslang::MachineIndependent;glslang::GenericCodeGen;glslang::OSDependent;glslang::OGLCompiler;glslang::HLSL;glslang::GenericCodeGen;glslang::OSDependent;glslang::OGLCompiler;SPIRV-Tools-opt;glslang::glslang>
             APPEND)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT glslang::SPIRV #############
        ...
        set_property(TARGET glslang::SPIRV PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPIRV_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPIRV PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_SPIRV_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPIRV PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPIRV_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPIRV PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPIRV_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::glslang #############
        ...
        set_property(TARGET glslang::glslang PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_glslang_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::MachineIndependent #############
        ...
        set_property(TARGET glslang::MachineIndependent PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_MachineIndependent_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::MachineIndependent PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_MachineIndependent_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::MachineIndependent PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_MachineIndependent_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::MachineIndependent PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_MachineIndependent_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::glslang-default-resource-limits #############
        ...
        set_property(TARGET glslang::glslang-default-resource-limits PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang-default-resource-limits_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang-default-resource-limits PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_glslang-default-resource-limits_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang-default-resource-limits PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang-default-resource-limits_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::glslang-default-resource-limits PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_glslang-default-resource-limits_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::SPVRemapper #############
        ...
        set_property(TARGET glslang::SPVRemapper PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPVRemapper_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPVRemapper PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_SPVRemapper_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPVRemapper PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPVRemapper_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::SPVRemapper PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_SPVRemapper_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## COMPONENT glslang::HLSL #############

        set(glslang_glslang_HLSL_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(glslang_glslang_HLSL_FRAMEWORKS_FOUND_RELEASE "${glslang_glslang_HLSL_FRAMEWORKS_RELEASE}" "${glslang_glslang_HLSL_FRAMEWORK_DIRS_RELEASE}")
        ...
        set_property(TARGET glslang_glslang_HLSL_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_DEPENDENCIES_RELEASE}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'glslang_glslang_HLSL_DEPS_TARGET' to all of them
        conan_package_library_targets("${glslang_glslang_HLSL_LIBS_RELEASE}"
                                      "${glslang_glslang_HLSL_LIB_DIRS_RELEASE}"
        ...
        set_property(TARGET glslang::HLSL
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_LIBRARIES_TARGETS}>
                     APPEND)

        if("${glslang_glslang_HLSL_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET glslang::HLSL
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET glslang::HLSL PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::HLSL PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::HLSL PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::HLSL PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_HLSL_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## COMPONENT glslang::OGLCompiler #############

        set(glslang_glslang_OGLCompiler_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(glslang_glslang_OGLCompiler_FRAMEWORKS_FOUND_RELEASE "${glslang_glslang_OGLCompiler_FRAMEWORKS_RELEASE}" "${glslang_glslang_OGLCompiler_FRAMEWORK_DIRS_RELEASE}")
        ...
        set_property(TARGET glslang_glslang_OGLCompiler_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_DEPENDENCIES_RELEASE}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'glslang_glslang_OGLCompiler_DEPS_TARGET' to all of them
        conan_package_library_targets("${glslang_glslang_OGLCompiler_LIBS_RELEASE}"
                                      "${glslang_glslang_OGLCompiler_LIB_DIRS_RELEASE}"
        ...
        set_property(TARGET glslang::OGLCompiler
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_LIBRARIES_TARGETS}>
                     APPEND)

        if("${glslang_glslang_OGLCompiler_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET glslang::OGLCompiler
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET glslang::OGLCompiler PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::OGLCompiler PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::OGLCompiler PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::OGLCompiler PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OGLCompiler_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::OSDependent #############
        ...
        set_property(TARGET glslang::OSDependent PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OSDependent_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::OSDependent PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_OSDependent_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::OSDependent PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OSDependent_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::OSDependent PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_OSDependent_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT glslang::GenericCodeGen #############
        ...
        set_property(TARGET glslang::GenericCodeGen PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_GenericCodeGen_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET glslang::GenericCodeGen PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glslang_glslang_GenericCodeGen_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET glslang::GenericCodeGen PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glslang_glslang_GenericCodeGen_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET glslang::GenericCodeGen PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glslang_glslang_GenericCodeGen_COMPILE_OPTIONS_RELEASE}> APPEND)
